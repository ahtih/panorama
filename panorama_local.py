...
if testcase_fnames:
	...
	for fname,img in zip(image_fnames,images_with_keypoints):
		panorama.write_output_file_image(output_fd,fname,img.focal_length_35mm,img.channel_keypoints)

	panorama.write_output_file_midsection(output_fd,len(image_fnames))
